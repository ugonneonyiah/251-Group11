...
**Interpretation:** This table compares asthma ED visit rates alongside PM2.5 and poverty levels across the three CES categories. Counties in the High CES category consistently show the greatest burden; they have the highest asthma ED rates, higher PM2.5, and higher poverty percentages compared to the other groups. Counties in the Low CES category have noticeably lower values across all three indicators. The Moderate group sits in between but still shows elevated asthma ED rates relative to the Low CES counties. Overall, this table highlights a clear pattern, supporting the idea that combined environmental and social vulnerabilities are associated with worse asthma outcomes.
...
-   **Interpretation:** This graph visually compares distributions across “Low,” “Moderate,” and “High” CES counties.The distribution of asthma ED rates is shifted higher in High CES counties compared to Low CES counties, highlighting disparities in asthma burden across environmental risk levels.
...
Scatterplots showed positive relationships between mean CES scores and asthma ED visit rates, as well as between PM2.5 levels and asthma ED visit rates. Boxplots of asthma ED visit rates by CES category suggested that counties classified as High CES had higher and more variable asthma ED rates than counties in the Low or Moderate CES categories. When we plotted asthma ED visit rates against county-level poverty, we saw that counties with higher poverty frequently clustered toward higher asthma ED visit rates. Together, the tables and plots highlight a pattern where multiple environmental and social indicators, including cumulative CES scores, PM2.5, and poverty ,move in the same direction as asthma ED burden at the county level.\
\
The findings underscore the connections between environmental justice, community conditions, and respiratory health. Counties with higher CES scores are often communities facing structural disadvantage, higher pollution exposure, and fewer protective resources. Higher asthma ED visits in these counties highlight how environmental inequities translate into real health consequences. This means that, for policymakers and public health agencies, interventions aimed at improving asthma outcomes cannot focus solely on clinical care; they also need to address environmental exposures, access to preventive resources, and neighborhood infrastructure.

Some limitations to note are that all our results are based on county-level data, which can mask neighborhood-level variation and may overlook communities within a county that experience even higher burdens. Because of this, we can’t make any conclusions about individuals or specific census tracts. There's also some timing mismatch across the datasets, since the CES indicators and asthma ED data don’t come from the exact same year. And since this is a cross-sectional, descriptive analysis, we can’t say that these environmental burdens *cause* higher asthma ED rates; we can only describe the patterns we see across counties.
